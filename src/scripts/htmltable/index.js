...
import HtmlTableRow from "./row";
import templateMarkdown from "./template-markdown";
import strPad from "./strpad";
import template from "../../templates/htmlTable.mustache?raw";
...
HtmlTable.prototype = {
  ...
  make: function (templateName, options) {
